...
from .tensor import (
    ISITensorDimensionMap,
    ISLLTensorDimensionMap,
    ISXYTensorDimensionMap,
    TensorDimensionMap,
)
        ...
        for t in tests:
            with self.subTest(test=t.name):
                ...
                if t.should_error:
                    ...
                    self.assertDictEqual(result.unwrap(), t.expected_slices)
