        ...
        tests: list[TestCase] = [
            TestCase(
                ...
                expected_coords=dataclasses.replace(
                    ...
                    step=[1, 2, 3],
                    variable=[entities.Parameter.DOWNWARD_SHORTWAVE_RADIATION_FLUX_GL],
                ),
                should_error=False,
            ),
            TestCase(
                ...
                expected_coords=dataclasses.replace(
                    ...
                    init_time=[dt.datetime(2024, 11, 5, 0, tzinfo=dt.UTC)],
                    step=[1, 2, 3],
                    variable=[entities.Parameter.WIND_U_COMPONENT_10m],
                ),
                should_error=False,
            ),
            TestCase(
        ...
        tests: list[TestCase] = [
            TestCase(
                ...
                expected_coords=dataclasses.replace(
                    ...
                    step=[1, 2],
                    variable=[entities.Parameter.TEMPERATURE_SL],
                ),
                should_error=False,
            ),
            TestCase(
                ...
                expected_coords=dataclasses.replace(
                    ...
                    init_time=[dt.datetime(2022, 1, 1, 3, tzinfo=dt.UTC)],
                    step=[1, 2],
                    variable=[entities.Parameter.CLOUD_COVER_LOW],
                ),
                should_error=False,
            ),
        ]
